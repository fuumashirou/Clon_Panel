...
class PromotionsControllerTest < ActionController::TestCase
  ...
  test "should create promotion" do
    assert_difference('Promotion.count') do
      post :create, promotion: { active: @promotion.active, end_time: @promotion.end_time, starred: @promotion.starred, start_time: @promotion.start_time }
    end
  ...
  test "should update promotion" do
    patch :update, id: @promotion, promotion: { active: @promotion.active, end_time: @promotion.end_time, starred: @promotion.starred, start_time: @promotion.start_time }
    assert_redirected_to promotion_path(assigns(:promotion))
  end
