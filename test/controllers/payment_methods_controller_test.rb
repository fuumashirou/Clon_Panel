...
class PaymentMethodsControllerTest < ActionController::TestCase
  ...
  test "should create payment_method" do
    assert_difference('PaymentMethod.count') do
      post :create, payment_method: { method: @payment_method.method, receiver_id: @payment_method.receiver_id, secret: @payment_method.secret }
    end
  ...
  test "should update payment_method" do
    patch :update, id: @payment_method, payment_method: { method: @payment_method.method, receiver_id: @payment_method.receiver_id, secret: @payment_method.secret }
    assert_redirected_to payment_method_path(assigns(:payment_method))
  end
